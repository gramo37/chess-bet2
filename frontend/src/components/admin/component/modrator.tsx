    ...
    async function onclick(e:any){
     ...
     return <div className="space-y-4">
             <div className="">
                ...
                <form className="flex justify-between mt-4 items-center">
                <div className="w-[40%]">
                  ...
                  <button
                type="submit"
                className=" h-[40px] w-[15%] self-center text-white bg-blue-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
                onClick={(e)=>onclick(e)}
              >
                Create Modrator
              </button>
