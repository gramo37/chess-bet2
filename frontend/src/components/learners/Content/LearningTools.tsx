    ...
    <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white py-12 px-6 rounded-lg shadow-2xl relative">
      <div className="container mx-auto text-center z-10 relative">
        ...
        <p className="text-lg sm:text-xl mb-10 max-w-3xl mx-auto leading-relaxed text-gray-200">
          We equip you with all the resources and tools you need to master chess
          at your own pace:
        </p>
        ...
        <div className="grid gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 mb-8">
          <div className="bg-gray-800 p-6 rounded-md shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-2">
            ...
            <p className="text-gray-300">
              Our expert coaches guide you through each aspect of the game using
              easy-to-understand video lessons. Lessons are structured
              progressively to build your skills step by step, with interactive
              examples that challenge you to apply what you've learned.
            </p>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-md shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-2">
            ...
            <p className="text-gray-300">
              We provide custom chess puzzles suited to your skill level that
              help reinforce key concepts, from basic tactics to advanced
              endgame studies. Daily drills are designed to sharpen your mind
              and improve your tactical awareness.
            </p>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-md shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-2">
            ...
            <p className="text-gray-300">
              Get personalized feedback on your games from our certified
              coaches. We’ll break down your moves, highlight mistakes, and
              teach you how to think like a chess master, so you can improve
              with every match.
            </p>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-md shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-2">
            ...
            <p className="text-gray-300">
              Once you're ready, you can challenge AI or real opponents in our
              online community. This practice is essential to put theory into
              action, and as you improve, you can rise through the ranks and
